...
const aviso_legal = () => {
  const card_content = (
    <div className={style.align_text_left + " " + style.card_content}>
      <p>
        En este proyecto no se almacenan cookies propias ni almacenamiento de
        datos privados
      </p>
      <p>
        La información sobre la compra de los NFTs y las direcciones wallet son
        de acceso público a través del smart contract y la blockchain de Polygon
      </p>
      <p>Asesoramiento legal por Locovera</p>
    </div>
  );
